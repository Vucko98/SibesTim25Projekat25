...
namespace CertificateManager
{
	public class ServiceCertValidator : X509CertificateValidator
	{
		...
		//servis validira klijenta, klijent je issued od servisa
		public override void Validate(X509Certificate2 certificate)
		{
			...
			if (certificate.Subject.Contains("client"))
				OrganizationalUnit = "AccountUsers";
			else if (certificate.Subject.Contains("admin"))
				OrganizationalUnit = "AccountManagers";
			else
				throw new Exception("Nepredvidjeni sertifikat");
